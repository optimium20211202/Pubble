...
export const topicList: Topic[] = [
  ...
  },
  {
    ...
    contents: [
      {
        id: 0,
        text: "近くのスーパーで自動レジが増え、従業員は、他のやりがいのある仕事をすることが多くなったらしいよ。",
        label: 0,
      ...
      {
        id: 1,
        text: "AIロボットを導入することで、工場現場などで人々は危険なことをしなくなって、より安全な仕事に専念できますね！",
        label: 0,
      ...
      {
        id: 2,
        text: "図書館でのAIアシスタントが増えて、人々が効率よく本を探せるようになってきた。本当に便利だよ。",
        label: 0,
